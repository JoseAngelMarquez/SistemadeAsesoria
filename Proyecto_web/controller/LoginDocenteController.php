<?php
// Se incluye el archivo que contiene la clase para manejar la autenticación de usuarios docentes.
require_once __DIR__ . '/../model/UserDocente.php';

class LoginController {

    // Método principal para manejar el inicio de sesión de los docentes.
    public function login() {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($id_user) {
                ...
                // Redirige al usuario docente a la página de inicio después de una autenticación exitosa.
                header("Location: /Proyecto_web/views/Docentes/Inicio.php");
